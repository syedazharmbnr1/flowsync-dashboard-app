...
import { Layers, Mail, Lock, AlertCircle, Loader } from 'lucide-react';
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 border-gray-700 rounded bg-gray-800 text-green-500 focus:ring-green-500"
                  />
      ...
      <div className="hidden lg:block relative w-0 flex-1">
        <div className="absolute inset-0 h-full w-full bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
          <div className="max-w-md p-6">
            <h2 className="text-3xl font-bold text-white mb-4">Welcome to FlowSync</h2>
            <p className="text-gray-300 mb-6">
              Streamline your workflow automation, boost team productivity, and gain valuable insights with our comprehensive dashboard.
            </p>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="ml-3 text-gray-300">Real-time analytics and insights</p>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <svg className="h-6 w-6 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="ml-3 text-gray-300">Powerful workflow automation tools</p>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <svg className="h-6 w-6 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="ml-3 text-gray-300">Seamless team collaboration</p>
              </div>
            </div>
          </div>
        </div>
